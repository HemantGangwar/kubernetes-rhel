...
Features
    ...
    Ì∫Ä Automated Kubernetes Deployment: Deploys Kubernetes control plane and worker nodes seamlessly.
    ‚úÖ Pre- and Post-deployment Checks: Validates environment readiness and cluster health.
    Ìª†Ô∏è Customizable: Execute specific tasks using tags for flexibility.
    Ì¥í CRI-O Installation: Configures CRI-O as the container runtime.
